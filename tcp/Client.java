...
public class Client {
    ...
    public Client(Socket socket, String username) {
        try {
            ...
            this.bufferedReader = new BufferedReader(new InputStreamReader(socket.getInputStream())); // lecture de texte à partir de flux d'entrée de caractères
            this.bufferedWriter= new BufferedWriter(new OutputStreamWriter(socket.getOutputStream())); //Écrit du texte dans un flux de sortie de caractères, en mettant les caractères en mémoire tampon
        } catch (IOException e) {
    ...
    public void sendMessage() {
        try {
            ...
            while (socket.isConnected()) {
                ...
                bufferedWriter.newLine(); // Insérer une nouvelle ligne au BufferedWriter
                bufferedWriter.flush(); // vide le tampon en ecrivant les données dans le flux
            }
        } catch (IOException e) {
            // Gracefully close everything.
            closeEverything(socket, bufferedReader, bufferedWriter);
