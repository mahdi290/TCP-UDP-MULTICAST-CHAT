     ...
     for (ClientHandler clientHandler : clientHandlers) {
         try {
             ...
             if (!clientHandler.clientUsername.equals(clientUsername)) {
                 ...
                 clientHandler.bufferedWriter.newLine(); // Insérer une nouvelle ligne au BufferedWriter
                 clientHandler.bufferedWriter.flush(); // vide le tampon en ecrivant les données dans le flux
             }
         } catch (IOException e) {
